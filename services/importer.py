...
class Importer:
    ...
    def __init__(self, exchange, period_start: datetime, period_end=None, interval=60, *args, **kwargs):
        ...
        self.dataset = Dataset(exchange=self.exchange.name, periodStart=period_start, periodEnd=period_end,
                               currency=self.exchange.currency, asset=self.exchange.asset).persist()
